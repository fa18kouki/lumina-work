        ...
        <div className="space-y-6">
          <div>
            <button
              type="button"
              onClick={handleLogin}
              className="w-full flex items-center justify-center gap-3 px-4 py-5 rounded-xl bg-[#00B900] hover:bg-[#00a000] transition-colors text-white font-bold text-xl shadow-lg"
            >
            ...
            <p className="text-center text-xs text-gray-400 mt-2">かんたん10秒で登録完了</p>
          </div>
          ...
          {emailSent ? (
            ...
            <p className="text-center">
              ...
              >
                メールアドレスで{fromDiagnosis ? "登録" : "ログイン"}する方はこちら
              </button>
            </p>
          )}
